...
// Маршрут куда передаются аргументы
  ...
  Widget build(BuildContext context) {
    ...
    final householdItemsDrawings1607 =[
    ...
    final householdItemsDrawings1610 =[
    ...
    if (currentArt == '1607'){householdItemsDrawings=householdItemsDrawings1607;}
    else if (currentArt == '1610'){householdItemsDrawings=householdItemsDrawings1610;}
