...
class _KettleDrawingSelectionScreenState extends State<KettleDrawingSelectionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('kettleList/art${argsFromKettleSelectionScreen.kettleArt}/kettleDrawings').snapshots(),
                  ...
                  child: SizedBox(height: 500,
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index){
                          final kettleDrawing = snapshot.data?.docs[index];
                          final largeCurrentDrawing = kettleDrawing?.get('currentKettleDrawing');
                          return Padding(
                                ...
                                Container(
                                  ...
                                  child: Row(children: [
                                    SizedBox(
                                        ...
                                        child: Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Image(image: NetworkImage(kettleDrawing?.get('currentKettleDrawing'))),
                                        )),
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          SizedBox(
                                            ...
                                            child: Text('Чертеж № ${kettleDrawing?.get('kettleDrawingNumber')}',
                                          ...
                                          Text(kettleDrawing?.get('kettleDrawingName'),
